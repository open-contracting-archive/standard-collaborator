...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CachedStandard.worked_example'
        db.add_column(u'main_cachedstandard', 'worked_example',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CachedStandard.worked_example'
        db.delete_column(u'main_cachedstandard', 'worked_example')
