...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CachedStandard.merging'
        db.add_column(u'main_cachedstandard', 'merging',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CachedStandard.merging'
        db.delete_column(u'main_cachedstandard', 'merging')
