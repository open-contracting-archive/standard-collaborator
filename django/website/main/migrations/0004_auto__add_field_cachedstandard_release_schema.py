...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CachedStandard.release_schema'
        db.add_column(u'main_cachedstandard', 'release_schema',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CachedStandard.release_schema'
        db.delete_column(u'main_cachedstandard', 'release_schema')
